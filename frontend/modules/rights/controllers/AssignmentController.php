...
class AssignmentController extends RController
{
	...
	*/
	public function actionUser()
	{
		...
		if( $assignSelectOptions!==array() )
		{
		    ...
		    if( isset($_POST['AssignmentForm'])===true )
			{
                $retry = false;
                $success = false;
                foreach($_POST['AssignmentForm'] as $key => $value){
                    if(is_int($key)){
                        $success = $this->authAssign($formModel, $model, $value);
                    }else{
                        $retry = true;
                    }
                }
                ...
                if($retry){
                    $success = $this->authAssign($formModel, $model, $_POST['AssignmentForm']);
                }
                if($success){
    ...
    protected function authAssign($formModel, $model, $data){
