...
class RGenerator extends CApplicationComponent
{
    ...
    */
    protected function getAllControllers()
    {
        ...
        $applicationModules = $this->getControllersInModules($basePath);
        $commonModules = $this->getControllersInModules(Yii::getPathOfAlias('common'));
        
        $items['modules'] = CMap::mergeArray($applicationModules, $commonModules);
        return $items;
    }
