...
class RAuthItemBehavior extends CBehavior
{
	...
	*/
	public function getRevokePermissionLink(CAuthItem $role)
	{
		...
		$link = "<div class='revoke-link-box alert'>".Rights::t('core', 'Revoke')."</div>";
		return CHtml::link($link, '#', array(
			'onclick'=>"
				jQuery.ajax({
					type:'POST',
	...
	*/
	public function getAssignPermissionLink(CAuthItem $role)
	{
		...
		$link = "<div class='assign-link-box alert'>".Rights::t('core', 'Assign')."</div>";
		return CHtml::link($link, '#', array(
			'onclick'=>"
				jQuery.ajax({
					type:'POST',
	...
	*/
	public function getInheritedPermissionText($parents, $displayType=false)
	{
		...
		return '<div class="inherited-item alert" title="'.implode('<br />', $items).'">'.Rights::t('core', 'Inherited').'*</div>';
	}
}
