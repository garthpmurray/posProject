...
<?php if(in_array('deleted', array_keys($columns))){ ?>
...
<?php } ?>
	...
	public static function label($n = 1) {
		return Yii::t('app', '<?php echo str_replace('Core', '', $modelClass); ?>|<?php echo $this->pluralize(str_replace('Core', '', $modelClass)); ?>', $n);
	}
...
<?php if(in_array('deleted', array_keys($columns))){ ?>
	...
	public function checkStatus($alias = null){
		$cdbCriteria = new CDbCriteria;
		$alias = isset($alias) ? $alias : $this->getTableAlias(true, false);
		if(get_class(Yii::app()) !== 'CConsoleApplication'){
			if(isset(Yii::app()->user->skipDefaultScope) && Yii::app()->user->skipDefaultScope === TRUE){
				return $cdbCriteria;
			}else{
				$cdbCriteria->addCondition($alias.'.'.$this->rstatus_fieldname.' = 0');
				$cdbCriteria->addCondition($alias.'.'.$this->rstatus_fieldname.' IS NULL', 'OR');
			}
		}
